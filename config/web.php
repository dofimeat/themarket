    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'admin/order-status/<id:\d+>' => 'admin/order-status',
                'admin/reviews' => 'admin/reviews',
                'admin/review-approve/<id:\d+>' => 'admin/review-approve',
                'admin/review-reject/<id:\d+>' => 'admin/review-reject',
                'admin/review-delete/<id:\d+>' => 'admin/review-delete',
                'brands' => 'site/brands',
