...
<div class="home-page">
    ...
    <section class="block products">
        <div class="block-head">
            <h2>Новинки/</h2>
            <a href="#" class="pill">Все изделия</a>
        </div>
    ...
    <section class="block brands">
        <div class="block-head">
            <h2>Бренды</h2>
            <a href="#" class="pill">Все бренды</a>
        </div>
    ...
    <section class="block cta">
        <div class="cta-box">
            <h2>Платформа начинается с профиля.</h2>
            <p>Зарегистрируйтесь, покупайте эксклюзивные вещи и создайте собственный бренд.</p>
            <a class="cta-button" href="#">Войти / Регистрация</a>
            <div class="cta-line"></div>
            <span>04 - Присоединяйся к name</span>
        </div>
    </section>

    <footer class="home-footer">
        <div class="home-wrap home-footer-wrap">
            <div>
                <h4>NAME</h4>
                <p>Платформа для авторских брендов и лимитированных коллекций.</p>
            </div>
            <div>
                <h4>Каталог</h4>
                <a href="#">Новинки</a>
